...
| [`shared`](modules/shared/) | 横断ユーティリティ (`utilhttp`, `utillog`, `utilcache`, `utilgrpc`, `utilotel`) | — | [modules/shared/README.md](modules/shared/README.md) |
...
devcontainer (`.devcontainer/`) を起動するか、以下のツールをホストに揃える: Go 1.26.3, sqlc, atlas, golangci-lint v2, protoc 28.3 + protoc-gen-go v1.34.2 + protoc-gen-go-grpc v1.5.1, kubectl + kind, docker compose。
